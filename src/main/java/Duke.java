            ...
            try {
                ...
                if (input.equals("list")) {
                    ...
                    if (tokenized_input.length == 1) {
                        throw new DukeException("The value/index of <" + tokenized_input[0] + "> cannot be empty.");
                    }

                    if (tokenized_input[0].equals("done")) {
                        // Marks task as Done
                        if (!TaskLogic.IntValidator(tokenized_input[1])) {
